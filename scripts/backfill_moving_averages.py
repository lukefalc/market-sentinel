"""Run a full moving-average rebuild/backfill.
...
def main() -> None:
    """Calculate and store full dated simple moving averages."""
    connection = None

    try:
        with timed_step("Backfill moving averages"):
        ...
        print(f"Moving average backfill failed: {error}", file=sys.stderr)
